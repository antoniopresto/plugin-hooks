...
var parallel = function (hookName, paramName) {
    var listeners = [];
    var register = function (pluginName, handler) {
        if (typeof handler !== 'function') {
            throw new Error(hookName + ": \"" + typeof handler + "\" is not a valid handler type");
        }
    ...
    return { register: register, exec: exec };
};
...
var waterfall = function (hookName, paramName) {
    var _this = this;
    var listeners = [];
    var register = function (pluginName, middleware) {
        if (typeof middleware !== 'function') {
            throw new Error(hookName + ": \"" + typeof middleware + "\" is not a valid middleware type");
        }
